package com.example.mytestsimpleadapter;
...
public class MainActivity extends Activity {
    ...
    private SimpleAdapter mySpinnerAdapter = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mySpinner = (Spinner) findViewById(R.id.spinner_1);
        ...
        btn_del.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!myBTList.isEmpty())
                {
                    ...
                    Toast.makeText(v.getContext(), "List name:" + map.get("name") + ", addr: " + map.get("address"), Toast.LENGTH_LONG).show();
        ...
        // For spinner
        mySpinnerAdapter = new SimpleAdapter(this,
                                            myBTList,
